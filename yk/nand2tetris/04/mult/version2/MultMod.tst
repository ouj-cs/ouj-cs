...
load Mult.hack,
output-file MultMod.out,
compare-to MultMod.cmp,
...
set PC 0,
set RAM[0] 32767,   // Set test arguments
set RAM[1] 1,
set RAM[2] -1;  // Ensure that program initialized product to 0
repeat 1000 {
  ticktock;
...
set PC 0,
set RAM[0] 111, // Set test arguments
set RAM[1] 111,
set RAM[2] -1;  // Ensure that program initialized product to 0
repeat 1000 {
  ticktock;
}
set RAM[0] 111, // Restore arguments in case program used them as loop counter
set RAM[1] 111,
output;
